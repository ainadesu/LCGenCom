      ...
      <Container>
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                <div className='slidebar-home'><p className='slidebar'>Chức Năng</p>
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/cmdbeginner" className='slidebar-link-on'>Lệnh Cho Người Dùng Mới</Link>
                    </p>
                    <p className='slidebar-option'>
...
export default ShowCmdbeginner_vi;
