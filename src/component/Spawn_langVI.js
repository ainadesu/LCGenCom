...
import HandleSpawn_vi from './Handle/HandleSpawn_vi';

function ShowSpawn_vi() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                <div className='slidebar-home'>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/spawn" className='slidebar-link-on'>Triệu Hồi</Link>
                    </p>
                    <p className='slidebar-option'>
