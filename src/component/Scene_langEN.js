...
import HandleScene_vi from './Handle/HandleScene_en';

function ShowScene_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/scene" className='slidebar-link-on'>Scene</Link>
                    </p>
                    <p className='slidebar-option'>
