...
import HandleLightcones_vi from './Handle/HandleLightcones_en';


function ShowLightcones_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/lightcones" className='slidebar-link-on'>Lightcones</Link>
                    </p>
                    <p className='slidebar-option'>
...
export default ShowLightcones_en;
