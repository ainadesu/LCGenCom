...
import HandleItems_vi from './Handle/HandleItems';

function ShowItems_vi() {
...
//   const currentComponent = getComponentByPath(location.pathname);
  ...
  const handleChange = (selectedOption) => {
    ...
    switch (selectedOption.value) {
        case 'Tiếng Việt':
            window.location.href = '/lang=vi/items';
            break;
        case '简体中文':
            window.location.href = '/lang=chs';
            break
        default:
            window.location.href = '/lang=en/items';
      }
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Chức Năng</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/items" className='slidebar-link-on'>Vật Phẩm</Link>
                    </p>
                    <p className='slidebar-option'>
