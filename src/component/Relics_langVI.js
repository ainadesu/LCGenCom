...
import HandleRelics_vi from './Handle/HandleRelics';

function ShowRelics_vi() {
...
//   const currentComponent = getComponentByPath(location.pathname);
  ...
  const handleChange = (selectedOption) => {
    ...
    switch (selectedOption.value) {
        case 'Tiếng Việt':
            window.location.href = '/lang=vi/relics';
            break;
        case '简体中文':
            window.location.href = '/lang=chs';
            break
        default:
            window.location.href = '/lang=en/relics';
      }
