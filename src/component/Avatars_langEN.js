...
import HandleAvatars_vi from './Handle/HandleAvatars_en';

function ShowAvatars_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/avatars" className='slidebar-link-on'>Character</Link>
                    </p>
                    <p className='slidebar-option'>
