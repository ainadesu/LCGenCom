...
import HandleScene_vi from './Handle/HandleScene_vi';

function ShowScene_vi() {
...
//   const currentComponent = getComponentByPath(location.pathname);
  ...
  const handleChange = (selectedOption) => {
    ...
    switch (selectedOption.value) {
        case 'Tiếng Việt':
            window.location.href = '/lang=vi/scene';
            break;
        case '简体中文':
            window.location.href = '/lang=chs';
            break
        default:
            window.location.href = '/lang=en/scene';
      }
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Chức Năng</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/scene" className='slidebar-link-on'>Cảnh</Link>
                    </p>
                    <p className='slidebar-option'>
