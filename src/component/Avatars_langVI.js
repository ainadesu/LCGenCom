...
import HandleAvatars_vi from './Handle/HandleAvatars_vi';

function ShowAvatars_vi() {
...
//   const currentComponent = getComponentByPath(location.pathname);
  ...
  const handleChange = (selectedOption) => {
    ...
    switch (selectedOption.value) {
        case 'Tiếng Việt':
            window.location.href = '/lang=vi/avatars';
            break;
        case '简体中文':
            window.location.href = '/lang=chs';
            break
        default:
            window.location.href = '/lang=en/avatars';
      }
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Chức Năng</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/avatars" className='slidebar-link-on'>Nhân Vật</Link>
                    </p>
                    <p className='slidebar-option'>
