...
import options from '../data/en/Relics.json'
import subAffix from '../data/en/subAffix.json'
import './handleLightcones.css';

function HandleRelics_en() {
  ...
  const updateSubOptions = (selectedOption) => {
    ...
    switch (type) {
      case "Nón":
        ...
        break;
      case "Tay":
        setSubOptions([{ label: "ATK", value: "1" }]);
        break;
      case "Áo":
        setSubOptions([
          { label: "HP %", value: "1" },
          { label: "ATK %", value: "2" },
          { label: "DEF %", value: "3" },
          { label: "Crit Ratte", value: "4" },
          { label: "Crit DMG", value: "5" },
          { label: "Outgoing Healing", value: "6" },
          { label: "Effect Hit Rate", value: "7" }
        ]);
        break;
      case "Giày":
        setSubOptions([
      ...
      case "Cầu":
          ...
          { label: "ATK %", value: "2" },
          { label: "DEF %", value: "3" },
          { label: "Physical Damage", value: "4" },
          { label: "Fire Damage", value: "5" },
          { label: "Ice Damage", value: "6" },
          { label: "Lightning Damage", value: "7" },
          { label: "Wind Damage", value: "8" },
          { label: "Quantum Damage", value: "9" },
          { label: "Imaginary Damage", value: "10" }
        ]);
        break;
      case "Dây":
          setSubOptions([
          { label: "Break Effect", value: "1" },
          { label: "Energy Regeneration Rate", value: "2" },
          { label: "HP %", value: "3" },
          { label: "ATK %", value: "4" },
          { label: "DEF %", value: "5" }
      ]);
    ...
    <>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div className="lightcones-content">
          ...
          <div style={{ display: 'flex' }}>
            <p className="name-of-selection">Main Stat:</p>
            <Select
            className="select"
            options={subOptions}
            placeholder="Select..."
          ...
          <div style={{ display:'flex' }}>
          <div style={{ width: '100%' }}>
              <p style={{color: 'white'}}>Sub Stat:</p>
...
export default HandleRelics_en;
