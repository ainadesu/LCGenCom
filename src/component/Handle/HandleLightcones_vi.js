...
import lightcones from '../data/vi/Lightcones.json'
import './handleLightcones.css'

function HandleLightcones_vi () {
  ...
  return (
    <>
      ...
      <div style={{display: 'flex'}}>
          <p className='name-of-selection'>Tên Nón Ánh Sáng: </p>
...
export default HandleLightcones_vi