...
import HandlePerfectRelics_vi from './Handle/HandlePerfectRelics_en';

function ShowPerfectRelics_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/perfectrelics" className='slidebar-link-on'>Perfect Relics</Link>
                    </p>
                    <hr/>
...
export default ShowPerfectRelics_en;
