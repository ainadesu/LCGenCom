...
import HandlePerfectRelics_vi from './Handle/HandlePerfectRelics_vi';

function ShowPerfectRelics_vi() {
...
//   const currentComponent = getComponentByPath(location.pathname);
  ...
  const handleChange = (selectedOption) => {
    ...
    switch (selectedOption.value) {
        case 'Tiếng Việt':
            window.location.href = '/lang=vi/perfectrelics';
            break;
        case '简体中文':
            window.location.href = '/lang=chs';
            break
        default:
            window.location.href = '/lang=en/perfectrelics';
      }
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Chức Năng</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/lightcones" className='slidebar-link'>Nón Ánh Sáng</Link>
                    </p>
                    <p className='slidebar-option'>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=vi/perfectrelics" className='slidebar-link-on'>Di Vật Hoàn Hảo</Link>
                    </p>
                    <hr/>
...
export default ShowPerfectRelics_vi;
