...
import HandleItems_vi from './Handle/HandleItems_en';

function ShowItems_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/items" className='slidebar-link-on'>Items</Link>
                    </p>
                    <p className='slidebar-option'>
