...
import HandleRelics_vi from './Handle/HandleRelics_en';

function ShowRelics_en() {
        ...
        <div style={{display: 'flex'}}>
            <div className='true-slidebar'>
                ...
                <p className='slidebar'>Feature</p>
                    ...
                    <p className='slidebar-option'>
                        <Link to="/lang=en/relics" className='slidebar-link-on'>Relics</Link>
                    </p>
                    <p className='slidebar-option'>
